...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("hi") || body.startsWith("jan") || body.startsWith("বট") || body.startsWith("janu")) {
            ...
            const randomReplies = ["🤌🤱🥺", "Yes 😀, I am here", "What's up?", "মেয়ে হলে বস মালয়েশিয়া সিঙ্গেল বয় কে 𝐊𝐈𝐒𝐒 দে 😒", "- অবহেলা করিস না-😑😪 - যখন নিজেকে বদলে ফেলবো -😌 - তখন আমার চেয়েও বেশি কষ্ট পাবি..!🙂💔", "চুমু খাওয়ার বয়স টা  চকলেট🍫খেয়ে উড়িয়ে দিলো মালয়েশিয়া সিঙ্গেল বয় বস 🥺🤗", "Bolo jaan ki korte panmr jonno"];
            if (!arr) {
